...
impl GlApp for ShaderLession {
    fn setup() -> Self {
        ...
        shader.load_shader(
            concat!(env!("CARGO_MANIFEST_DIR"), "/src/shader/01_ex_2/vertex.vs"),
            concat!(env!("CARGO_MANIFEST_DIR"), "/src/shader/01_ex_2/fragment.fs"),
        );
        Self {
            vao,
            shader,
    ...
    fn render(&mut self) {
        unsafe {
            ...
            self.shader.set_float("offset", 0.2);
